...
<!--                            трудоустройства</p> -->
                    ...
                    <a href='#' class="big_section_consult desctop-width btn_inherit btn-consilt"><?php echo($lang ? 'консультация' : 'консультація'); ?></a>
                </div>
                <div class="big_section-right">
                    <img src="<?= get_template_directory_uri(); ?>/images/new_design/1.svg" alt="">
                    <a href='#' class="big_section_consult small-width btn_inherit btn-consilt"><?php echo($lang ? 'Консультация' : 'Консультація'); ?></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="special_wrapper"
            ...
            <div class="container">
                ...
                <div class="special_img">
                    <img src="<?php echo get_template_directory_uri() ?>/images/new_design/boy.png" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class='help'>
        ...
        <div class="container">
            ...
            <div class="help_items">
                <div class="help_item">
                    <img src="<?php echo get_template_directory_uri() ?>/images/new_design/2.svg" alt=""
                         class="help_item_img">
                    ...
                    <a href="#"  class='help_item_link btn_inherit btn-consilt'><?php echo($lang ? 'Оставить заявку' : 'Залишити заявку'); ?></a>
                </div>
                <div class="help_item">
                    <img src="<?php echo get_template_directory_uri() ?>/images/new_design/4.svg" alt=""
                         class="help_item_img">
                    <div class="help_item_title">
                    ...
                    <a href="https://pathfinder.jobs/" target="_blank" class='help_item_link btn_inherit'><?php echo($lang ? 'Узнать направление' : 'Дізнатися напрямок'); ?></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class='programing'>
        ...
        <div class="container">
            <div class="programing_header">
                ...
                <a href="#" class='programing_link desctop-width btn_inherit btn-consilt'><?php echo($lang ? 'Консультация' : 'Консультація'); ?></a>
            </div>
            <div class="programing_footer">
                <img src='<?php echo get_template_directory_uri() ?>/images/new_design/6.svg' alt="" class="programing_img">
                <a href="#" class='programing_link small-width btn_inherit btn-consilt'><?php echo($lang ? 'Консультация' : 'Консультація'); ?></a>
            </div>
            ...
            <div class="programing_benefits">
                ...
                <h2 class="title-w text-center benefites-list__title">
        ...
        <div class="employment_wrapper"
            ...
            <div class="container">
                ...
                <div class="employment-left">
                    <div class="employment_title work-title" style='color:white;'>
                        <h2>  <?php echo $employment['title'] ?></h2>
                    </div>
                    <a href="#" class='employment_link desctop-show btn-consilt'><?php echo($lang ? 'Бесплатная консультация' : 'Безкоштовна консультація'); ?></a>
                </div>
                <div class="employment-right">
                    <div class="employment-items">
                        ...
                        <!--                        </div>-->
                        <a href="#" class='employment_link mobile_show  btn-consilt'><?php echo($lang ? 'Бесплатная консультация' : 'Безкоштовна консультація'); ?></a>
                    </div>
                </div>
            </div>
            <img src="<?php echo get_template_directory_uri() ?>/images/new_design/girl.png" alt="" class="employment_img">
        </div>
    </section>
<?php endif; ?>
    ...
    <section class='preparation'>
        ...
        <div class="container">
            ...
            <div class="preparation_header ">
                ...
                <a href="#" class="preparation_link desctop-width">
                    Консультация
                </a>
            </div>
            <div class="preparation_content">
                <img src="<?php echo get_template_directory_uri() ?>/images/new_design/5.svg" alt="" class="preparation_img">
                <a href="#" class="preparation_link work-link btn_inherit btn-consilt">
                    Консультация
                </a>
            </div>
        </div>
    ...
    <section class='working'>
        ...
        <div class="container">
            ...
            <div class="working_content">
                <a href="#" class="working_link work-link btn_inherit">
                    Консультация
                </a>
                <img src="<?php echo get_template_directory_uri() ?>/images/new_design/10.svg" alt=""
                     class="working_img work-img">
            </div>
            <section class="company-list">
    
        <div class="title-w text-center"><?php echo($lang ? 'Наши партнеры' : 'Наші  партнери'); ?></div>
        ...
        <?php
            ...
            if( have_rows('company') ): 
                ...
                <a href="<?php echo the_sub_field('company_link')?>" target="_blank" rel="noreferrer noopener nofollow" class="company">
                 <img src="<?php echo the_sub_field('company_img'); ?>" />
                </a>
    ...
    <section class='jungo section--blue'>
        ...
        <div class="container">
            ...
            <div class="jungo_content work-content">
                <a href="https://www.jungo.dev" target="_blank" class="jungo_link work-link btn_inherit"><?php echo($lang ? 'Больше о JunGО' : 'Більше про JunGО'); ?></a>
                <ul class="jungo_ul">
...
<?php endif; ?>
<script>
document.querySelectorAll('.btn-consilt').forEach(element => {
        element.addEventListener('click',()=>{
            document.body.classList.add('show-callback');
        })
    });
</script>
<?php
